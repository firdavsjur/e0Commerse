    ...
    "paths": {
        ...
        "/report/staff-sale": {
            "get": {
                ...
                "operationId": "get_list_staff_selled",
                "parameters": [
                    {
                        "type": "string",
                        "description": "offset",
        ...
        "/transferProduct": {
            "put": {
                ...
                "operationId": "tranfer_product",
                "parameters": [
                    {
                        "description": "transferProudctRequest",
                        "name": "transferProduct",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.TransferProductRequest"
                        }
                    }
                ],
                "responses": {
