...
type StockRepoI interface {
	...
	TransferProduct(ctx context.Context, req *models.TransferProductRequest) error
}
...
type StaffRepoI interface {
	...
	GetByIDTotalSelledStaff(ctx context.Context, req *models.StaffPrimaryKey) ([]*models.GetTotalSelledStaff, error)
	GetListTotalSelledStaff(ctx context.Context, req *models.GetListStaffRequest) (resp []*models.GetTotalSelledStaff, err error)
}
...
type OrderRepoI interface {
	...
	TotalOrderSum(ctx context.Context, req *models.TotalOrderSumRequest) (*models.TotalOrderSumResponse, string, error)
}
